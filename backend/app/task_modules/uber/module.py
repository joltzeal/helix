    ...
    manifest = TaskModuleManifest(
        ...
        result_blocks=[
            TaskResultBlock(
                ...
                source_key="cards",
                description="展示 cards 提交后的本地持久化结果。",
            )
        ],
        config_fields=[
            TaskConfigField(
            ...
            TaskConfigField(
                ...
                field_type="text",
                required=True,
                description="CloudMail 接口服务地址，用来拼接 /api/public/genToken、/api/public/emailList 等路径。",
            ...
            TaskConfigField(
                ...
                field_type="text",
                required=True,
                description="生成 CloudMail token 时使用的管理员邮箱。",
            ...
            TaskConfigField(
                ...
                field_type="password",
                required=True,
                description="生成 CloudMail token 时使用的管理员邮箱密码。",
            ...
            TaskConfigField(
                ...
                description="创建窗口时按任务项轮询选择；coreProduct 固定为 chrome。",
            ),
            TaskConfigField(
                key="ostype",
                label="操作系统平台",
            ...
            TaskConfigField(
                ...
                required=False,
                default=False,
                description="开启后 /browser/open 会添加 --headless，并强制忽略默认页，由脚本自行打开页面。",
            ),
            TaskConfigField(
                key="abort_image",
                label="无图模式",
            ...
            TaskConfigField(
                ...
                field_type="text",
                required=True,
                default="wmsgjbas.shop",
                description="自动创建随机邮箱时使用的域名。",
                placeholder="wmsgjbas.shop",
            ),
            TaskConfigField(
            ...
            TaskConfigField(
                ...
                required=True,
                default=25,
                description="Uber gift card 自定义金额。",
                placeholder="25",
            ),
            TaskConfigField(
                ...
                required=True,
                default="example.com",
                description="礼品卡收件人邮箱使用的域名，运行时会随机生成前缀。",
            ...
            TaskConfigField(
                ...
                required=True,
                default="US",
                description="支付表单 billing-country-iso2 的国家代码。",
                placeholder="US",
            ),
            TaskConfigField(
                ...
                required=True,
                default="10001",
                description="支付表单 postal-code 字段。",
                placeholder="10001",
            ),
        ],
    )
