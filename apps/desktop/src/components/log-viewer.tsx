...
interface LogViewerTerminalProps extends Omit<React.ComponentProps<"div">, "children" | "title"> {
  ...
  autoScroll?: boolean
  /** Show level/search filters instead of the compact terminal toolbar. @default false */
  filterable?: boolean
...
function LogViewerTerminalPlain({
  entries,
  title,
  maxHeight,
  lineNumbers,
  ...
  className,
  ...props
}: Omit<LogViewerTerminalProps, "filterable">) {
